            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 mt-3">
                    ...
                    <div class="card h-100">
                        <img src="../../assets/physics.jpg" class="card-img-top img-fluid" alt="Subjects">
                        <div class="card-body">
                ...
                <div class="col-lg-3 col-md-4 mt-3">
                    ...
                    <div class="card h-100">
                        <img src="../../assets/maths.jpg" class="card-img-top img-fluid" alt="Subjects">
                        <div class="card-body">
                ...
                <div class="col-lg-3 col-md-4 mt-3">
                    ...
                    <div class="card h-100">
                        <img src="../../assets/chemistry.jpg" class="card-img-top img-fluid" alt="Subjects">
                ...
                <div class="col-lg-3 col-md-4 mt-3">
                    ...
                    <div class="card">
                        <img src="../../assets/biology.jpg" class="card-img-top img-fluid" alt="Subjects">
                        <div class="card-body h-100">
                ...
                <div class="col-lg-3 col-md-4 mt-4">
                    ...
                    <div class="card h-100">
                        <img src="../../assets/account.jpg" class="card-img-top img-fluid" alt="Subjects">
                        <div class="card-body">
                ...
                <div class="col-lg-3 col-md-4 mt-4">
                    ...
                    <div class="card h-100">
                        <img src="../../assets/digitallogics.jpg" class="card-img-top img-fluid" alt="Subjects">
                        <div class="card-body">
                ...
                <div class="col-lg-3 col-md-4 mt-4">
                    ...
                    <div class="card h-100">
                        <img src="../../assets/english.jpg" class="card-img-top img-fluid" alt="Subjects">
                        <div class="card-body">
                ...
                <div class="col-lg-3 col-md-4 mt-4">
                    ...
                    <div class="card h-100">
                        <img src="../../assets/socialstudies.jpg" class="card-img-top img-fluid" alt="Subjects">
                        <div class="card-body">
