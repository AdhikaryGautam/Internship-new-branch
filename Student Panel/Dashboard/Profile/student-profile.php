        ...
        <div class="row">
            <div class="col-md-4 profileBox text-center">
                <div class="profilePicture">                
                    <img src="../../assets/reviewPic-4.jpeg" alt="" class="img-fluid mt-3">
                        ...
                        <div class="row text-DARK mt-4">
                            ...
                            <div class="col-12 mt-4">
                                ...
                                <div class="card text-dark mt-3"style="width:150px">
                                    <img class="card-img-top" src="../../assets/info.jpg"alt="identificationProof" style="width:100%"data-toggle="modal"
                                        data-target="#myModal">
                                    <span>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body p-0">
                                                ...
                                                <img class="img-fluid mt-n4" src="../../assets/info.jpg" alt="Card image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
