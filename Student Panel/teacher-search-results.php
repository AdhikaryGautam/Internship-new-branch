            ...
            <hr class="mb-0">
              ...
              <p class="lead m-0 p-0 float-right">Search results for <span>"s"</span></p>
                ...
                <div class="row mt-md-0 mt-5 mb-0">
                    <div class="dropdown d-md-none d-block col-sm-12">
                            ...
                            <div class="col-xl-4 col-sm-6 mt-4">
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="mb-0 mt-2 cardInfo lead text-dark">$50/month</p>
                                        <hr class="mb-2">

                                        <div class="btn-group d-inline">
                                            <a href="#/" class="btn btns mr-2 mt-2">View Profile</a>
